...
Route::controller(UserController::class)->group(function () {
    ...
    Route::post('/logout', 'doLogout')->middleware([OnlyUserMiddleware::class]);
});

Route::controller(TodolistController::class)->middleware([OnlyUserMiddleware::class])->group(function () {
